...
const { validationLogin, validationRegister, validationCreateClient, validationRepayLoan } = require('../middlewares/mifosmiddleware');
...
router.post('/mifos-make-loan-repayment', [validationRepayLoan], makeLoanRepayment);
